 ...
 * @endcode
 */
$settings['hash_salt'] = '2VKamWWqQk1-WZxyNRemXOiOIWhJvHirUnR9fX3ZocOvS4VoweX3a4R-hRtqC0yv-04IMrX50g';
...
foreach ($cf_service_data as $service_list) {
  foreach ($service_list as $service) {
    if ($service['name'] === 'database') {
      ...
      echo '<pre>';
      var_dump(getenv('S3_PROXY_PATH_CMS'));
      var_dump($S3_PROXY_PATH_CMS);
      var_dump($_SERVER['HTTP_HOST'] . $S3_PROXY_PATH_CMS);
      var_dump($_SERVER);
      echo '</pre>';
