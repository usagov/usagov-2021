console.log("in componenet javascript");

const stateInputElement = document.getElementById("state-info");
// const stateListFromSelect =

// const getSaytOptions(){
...
//     // check against the abbreviation of the state
//     // if (inputValue.length === 2 && inputValue.toUpperCase()=== optionEl.abbr) {
//     //   options.push(optionEl);
//     // }
//   }
...
//  */
// const toggleList = (el) => {
//   console.log("in component toggle list");
