$(".slides").slick({
  ...
  "prevArrow":
    ...
    '  <img src="/themes/custom/usagov/images/Reimagined_Carousel_Left_Arrow.svg" style="height:40px;width:40px" alt="Go to previous card"/>' +
    "</button>",
  "nextArrow":
    '<button class="next slick-next slick-arrow">' +
    '  <span class="sr-only">Next slides</span>' +
    '  <img src="/themes/custom/usagov/images/Reimagined_Carousel_Right_Arrow.svg" style="height:40px;width:40px" alt="Go to next card"/>' +
    "</button>",
  "responsive": [
    {
      "breakpoint": 2048,
