/*
This is our old gulpfile from when we were using gulp-sass
I've kept it around to reference so we can make sure we include all existing functionality into our new workflow
I think es-lint is the only thing we will need to account for
*/
...
const pkg = require("@uswds/uswds/package.json");
