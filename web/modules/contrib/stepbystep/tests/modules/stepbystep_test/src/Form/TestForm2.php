 ...
 */
class TestForm2 extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'stepbystep_test_form_2';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $parameter1 = NULL) {
    ...
    $form['textfield1'] = [
      ...
      '#title' => $this->t('Form 2 text field 1'),
    ];
    $form['textfield2'] = [
      '#type' => 'textfield',
      '#default_value' => $config->get('textfield2'),
      '#title' => $this->t('Form 2 text field 2'),
    ];
    $form['details1'] = [
      '#type' => 'details',
      '#title' => 'Form 2 Details 1',
      '#open' => TRUE,
    ];
    $form['details1']['textfield3'] = [
      '#type' => 'textfield',
      '#default_value' => $config->get('textfield3'),
      '#title' => $this->t('Form 2 text field 3'),
    ];
    $form['details1']['textfield4'] = [
      '#type' => 'textfield',
      '#default_value' => $config->get('textfield4'),
      '#title' => $this->t('Form 2 text field 4'),
    ];
    $form['extra_actions'] = [
      '#type' => 'details',
      '#title' => 'Form 2 extra actions',
      '#open' => TRUE,
    ];
    $form['extra_actions']['submit1'] = [
      '#type' => 'submit',
      '#value' => $this->t('Form 2 submit extra 1'),
      '#button_type' => 'primary',
      '#submit' => ['::submitExtra'],
    ];
    $form['extra_actions']['submit2'] = [
      '#type' => 'submit',
      '#value' => $this->t('Form 2 submit extra 2'),
      '#button_type' => 'primary',
      '#submit' => ['::submitExtra'],
    ];
    $form['actions'] = [
