...
use Drupal\tome_sync\Normalizer\UserEntityNormalizer;
use Prophecy\Argument;
use Symfony\Component\Serializer\Serializer;

/**
 * @coversDefaultClass \Drupal\tome_sync\Normalizer\UserEntityNormalizer
 * @group tome_sync
 */
class UserEntityNormalizerTest extends UnitTestCase {
  ...
  public function testNormalize() {
    ...
    $this->assertEquals(['field_foo' => 'foo'], $values, 'The access, login, and init keys were removed properly.');
  }
