...
if [ -f "/etc/php82/php-fpm.d/env.conf.tmpl" ]; then
  cp /etc/php82/php-fpm.d/env.conf.tmpl /etc/php82/php-fpm.d/env.conf
  echo "env[S3_PROXY_PATH_CMS] = "$S3_PROXY_PATH_CMS >> /etc/php82/php-fpm.d/env.conf
  echo "env[S3_PROXY_CMS] = "$S3_PROXY_CMS >> /etc/php82/php-fpm.d/env.conf
  echo "env[S3_ROOT_CMS] = "$S3_ROOT_CMS >> /etc/php82/php-fpm.d/env.conf
  echo "env[S3_HOST] = "$S3_HOST >> /etc/php82/php-fpm.d/env.conf
fi
...
if [ -f "/etc/php82/conf.d/newrelic.ini" ]; then
