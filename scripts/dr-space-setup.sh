...
#$echo bin/snapshot-backups/local-snapshot-download $APP_SPACE $SNAPTAG
#pushSnapshots 
...
#deployAPIProxyApp 
#deployCronApp 
REPORTER_DIGEST='sha256:db9a647eb54f371ebab1bb16e63abbb7b7cc04bee15b688f7056d682effa1db9'
REPORTER_BUILD=15123
