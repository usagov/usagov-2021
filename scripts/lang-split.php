...
die("One time use script to split spanish lanauge node translations into separate nodes. Comment out this line to run.\n\nUSAGE: drush scr lang-split.php >> lang-split.log;\n\n");
