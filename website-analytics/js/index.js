  ...
  var BLOCKS = {
    ...
    "cities": renderBlock()
      .transform(function(d) {
        ...
        city_list_filtered = addShares(city_list_filtered, function(d){return d.users;});
    ...
    "international_visits": renderBlock()
      .transform(function(d) {
        var countries = addShares(d.data, function(d){ return d.users; });
    ...
    "top-external-links": renderBlock()
      .transform(function(d) {
        ...
        selection.selectAll(".label")
          ...
          .append("a")
            ...
            .attr("href", function(d) {
              return exceptions[d.pagePath] || ("http://" + d.pagePath);
            })
            .text(function(d) {
