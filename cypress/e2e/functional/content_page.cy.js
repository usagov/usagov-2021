describe('Content Page', () => {
    ...
    it('BTE 33: Share this page function works correctly for facebook, twitter, and email', () => {
        cy.get('.additional_body_info')
            .find('#sm-share')
            .should('exist')
            .get('div.share-icons>a').eq(0).should('have.attr', 'href', 'http://www.facebook.com/sharer/sharer.php?u=https://www.usa.gov/disaster-assistance&v=3')
            .get('div.share-icons>a').eq(1).should('have.attr', 'href', 'http://twitter.com/intent/tweet?source=webclient&text=https://www.usa.gov/disaster-assistance')
            .get('div.share-icons>a').eq(2).should('have.attr', 'href', 'mailto:?subject=https://www.usa.gov/disaster-assistance')
    })
